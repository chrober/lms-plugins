...
Bliss 'Em All is intentionally absent until its installable plugin packages,
bundled native executables, checksums, and compatibility checks have passed the
release process. A scaffold is never advertised as an available LMS plugin.
